schemes['computer_science'] = {
    ...
    cele: [
        ...
        ['Linus Torvalds', 'An infinite number of monkeys typing into GNU emacs would never make a good program.'],
        ...
        ['Linus Torvalds', '*YOU* are full of bullshit.'],
        ['Linus Torvalds', 'C++ is a mess.'],
    ],
    //至少3个有关第一个学科的思想（主义）
    prin: ['构造', '直觉', '逻辑'],
    //至少3个有关第一个学科的性质
